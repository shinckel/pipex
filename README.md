...
| **`valgrind`** | `valgrind --track-fds=yes` | check if all your fds are closed at the end of the process. Do it in your terminal and not in VSCode, otherwise it will show the fds open to allow communication between its sandbox and your computer. |
